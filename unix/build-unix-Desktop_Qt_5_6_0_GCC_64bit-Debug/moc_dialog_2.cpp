...
QT_MOC_LITERAL(3, 32, 21) // "on_pushButton_clicked"
    ...
    "Dialog_2\0on_buttonBox_accepted\0\0"
...
void Dialog_2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Dialog_2 *_t = static_cast<Dialog_2 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Dialog_2::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Dialog_2.data,
      qt_meta_data_Dialog_2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Dialog_2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Dialog_2.stringdata0))
        return static_cast<void*>(const_cast< Dialog_2*>(this));
